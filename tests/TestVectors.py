...
def test_vectors(pattern=None):
    ...
    code_block = InstructionBlockDescription("bb_isaacrc32_3", 0x000003c4)
    code_block.addInstruction("custom3", rd =1, rs1=10, rs2=11)
    code_block.addInstruction("custom3", rd =2, rs1=10, rs2=11)
    code_block.addInstruction("custom3", rd =3, rs1=10, rs2=11)
    code_block.addInstruction("custom3", rd =4, rs1=10, rs2=11)
    code_blocks.append(code_block)
    code_block = InstructionBlockDescription("bb_isaacrc32_5", 0x000003c4)
    code_block.addInstruction("custom5", rd =1, rs1=10, rs2=11)
    code_block.addInstruction("custom5", rd =2, rs1=10, rs2=11)
    code_block.addInstruction("custom5", rd =3, rs1=10, rs2=11)
    code_block.addInstruction("custom5", rd =4, rs1=10, rs2=11)
    code_blocks.append(code_block)
    code_block = InstructionBlockDescription("bb_isaacrc32_10", 0x000003c4)
    code_block.addInstruction("custom10", rd =1, rs1=10, rs2=11)
    code_block.addInstruction("custom10", rd =2, rs1=10, rs2=11)
    code_block.addInstruction("custom10", rd =3, rs1=10, rs2=11)
    code_block.addInstruction("custom10", rd =4, rs1=10, rs2=11)
    code_blocks.append(code_block)
    code_block = InstructionBlockDescription("bb_isaacrc32_14", 0x000003c4)
    code_block.addInstruction("custom14", rd =1, rs1=10, rs2=11)
    code_block.addInstruction("custom14", rd =2, rs1=10, rs2=11)
    code_block.addInstruction("custom14", rd =3, rs1=10, rs2=11)
