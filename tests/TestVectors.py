...
def test_vectors(pattern=None):
    ...
    desc.addInstruction("add" , rd=4, rs1=10, rs2=11)
    code_blocks.append(desc)
    ...
    desc.addInstruction("add"    , rd =3, rs1=14, rs2=15)
    #desc.addInstruction("lw"     , rd =3, rs1=14)
    desc.addInstruction("mul"    , rd =4, rs1=16, rs2=17)
    code_blocks.append(desc)
