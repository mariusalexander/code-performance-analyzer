...
def test_vectors(pattern=None):
    ...
    code_blocks = []
    code_block = InstructionBlockDescription("ex_sw", 0x100047c)
    ...
    code_block = InstructionBlockDescription("ex_ppt", 0x100047c)
    ...
    code_block = InstructionBlockDescription("ex_adds", 0x000003c4)
    ...
    code_block = InstructionBlockDescription("ex_load_incr_store", 0x000003c4)
    ...
    code_block = InstructionBlockDescription("ex_mul_adds", 0x000003c4)
